...
const MAX_OFFSET_BYTES: usize = PUBKEY_BYTES - size_of::<ReadBytesType>();
...
impl PubkeyBinCalculatorBuilder {
    ...
    pub fn with_bins_and_offset(num_bins: NonZeroUsize, offset: usize) -> PubkeyBinCalculator {
        ...
        PubkeyBinCalculator {
            byte_offset,
            bit_offset,
            mask: num_bins_mask as ReadBytesType,
        }
    }
}
...
mod tests {
    ...
    /// Ensure enough is ready from the pubkey to calculate the bin.
    #[test]
    #[should_panic(
    ...
    fn test_not_enough_read_from_pubkey_should_panic() {
        ...
        let bin_calculator = PubkeyBinCalculator {
            byte_offset: 0,
            bit_offset: bad_bit_offset as usize,
